...
%%%%%%%%%%%
graphType = 'Welfare 2nd Order'; % 'Rules Comparison', 'Risk-Free vs Risky', 'Welfare 2nd Order'
%%%%%%%%%%%
...
exportgraphics(f, ...
    strjoin({pathImages 'IRFs' modelName 'DefR' defProcess 'RF vs Risky' ['Graph - Inflation - Regimes ' num2str(regIRFs(1)) num2str(regIRFs(2)) ' - All Shocks - ' 'IRF Type ' irf_type ' - PolicyRule All - ' title_polRule_simple ' ' num2str(iFigure) '.png']}, filesep));
edu_GraphSetInterpreter(previousInterpreter);
