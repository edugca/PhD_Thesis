...
%                                 g);
    ...
    elseif startsWith(m.user_data.conf_policyRule, "fixedIntercept_") || startsWith(m.user_data.conf_policyRule, "rRN_") || startsWith(m.user_data.conf_policyRule, "rRNWrong_") ...
