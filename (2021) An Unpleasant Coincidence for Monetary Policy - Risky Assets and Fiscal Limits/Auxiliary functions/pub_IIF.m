% Obtained from https://www.mathworks.com/matlabcentral/fileexchange/39735-functional-programming-constructs

function varargout = pub_IIF(condition, true_action, false_action)
